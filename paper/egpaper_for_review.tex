...
By submitting a manuscript to ICB, the authors assert that it has not been
...
either has been or will be submitted during the ICB 2015 review period to
{\bf either a journal} or any conference (including ICB 2015) or any
workshop. 
 {\bf  Papers violating this condition will be rejected and a list of violating authors may be included in the proceedings.} 
...
(2)~argue in the body of your paper why your ICB paper is non-trivially
different from these concurrent submissions, and (3)~include anonymized
versions of those papers in the supplemental material.

\subsection{Paper length}
Consult the call for papers for page-length limits. Over length papers will simply not be reviewed.  This includes papers
...
and you believe that the ICB 2015 audience would like to hear about your
...
chronological) order, so prefer \cite{Alpher03,Alpher02, Alpher04} to
\cite{Alpher02,Alpher03, Alpher04}.
